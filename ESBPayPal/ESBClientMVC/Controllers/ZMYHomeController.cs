...
{
    public class ZMYHomeController : Controller
    {
...
*/
            ...
            // subtotal = listCarts.Sum(x => x.QUANTITY * x.UNITPRICE).ToString()
           ...
           // Adding description about the transaction
            ...
            transactionList.Add(new Transaction()
            {
                ...
                invoice_number = numIterations.ToString(), //Generate an Invoice No
                amount = amount,
                item_list = itemList
            });
...
/*
// Payee of the Payment (Bénéficiaire) 

          Payee HBpayee = new Payee()
          {
              email = "hb@business.com",          
              erchant_id = "2Q3EQR6JZWBWU"          
          }; 
*/
